...
public enum UnitType {
    tank("\uD83D\uDE92", 2, 2, //фигурка скорой помощи
            ...
            Stream.of(Direction.up, Direction.left, Direction.right, Direction.down)
                    .collect(Collectors.toCollection(ArrayList::new))),
    ship("\uD83D\uDEA2", 4, 4, Stream.of(GroveType.SEE, GroveType.RIVER) //фигурка коробля
            .collect(Collectors.toCollection(ArrayList::new)),
            Stream.of(Direction.up, Direction.left, Direction.right, Direction.down,
            Direction.rightDown, Direction.leftDown, Direction.rightUp, Direction.leftUp)
            .collect(Collectors.toCollection(ArrayList::new))),
    plane("\uD83D\uDE81", 4, 4, //фигурка вертолетик
    ...
    militia("\uD83C\uDF33", 2, 2, //дерево
            ...
            Direction.rightDown, Direction.leftDown, Direction.rightUp, Direction.leftUp)
            .collect(Collectors.toCollection(ArrayList::new))),
    infantry("\uD83D\uDD2B", 2, 2, //пистолет
            Stream.of(GroveType.RIVER_CROSS, GroveType.EARTH)
            .collect(Collectors.toCollection(ArrayList::new)),
            Stream.of(Direction.up, Direction.left, Direction.right, Direction.down)
            .collect(Collectors.toCollection(ArrayList::new))),
    headquarter("\uD83C\uDFE0", 0, 0, null, null), //дом
    engineer("\uD83D\uDD28", 2, 0, //молоток
            Stream.of(GroveType.RIVER_CROSS, GroveType.EARTH, GroveType.RIVER)
            .collect(Collectors.toCollection(ArrayList::new)),
            Stream.of(Direction.up, Direction.left, Direction.right, Direction.down)
            .collect(Collectors.toCollection(ArrayList::new))),
    commander("\uD83C\uDF1F", 100, 1, //звезда
            Stream.of(GroveType.RIVER_CROSS, GroveType.EARTH, GroveType.RIVER)
            .collect(Collectors.toCollection(ArrayList::new)),
            Stream.of(Direction.up, Direction.left, Direction.right, Direction.down)
            .collect(Collectors.toCollection(ArrayList::new))),
    artillery("\uD83D\uDD2D", 3,3, //телескоп
            Stream.of(GroveType.RIVER_CROSS, GroveType.EARTH, GroveType.RIVER)
            .collect(Collectors.toCollection(ArrayList::new)),
            Stream.of(Direction.up, Direction.left, Direction.right, Direction.down,
            Direction.rightDown, Direction.leftDown, Direction.rightUp, Direction.leftUp)
            .collect(Collectors.toCollection(ArrayList::new))),
    antiPlaneGun("\uD83D\uDCA3", 2, 1, //бомба
            Stream.of(GroveType.RIVER_CROSS, GroveType.EARTH, GroveType.RIVER)
            .collect(Collectors.toCollection(ArrayList::new)),
            Stream.of(Direction.up, Direction.left, Direction.right, Direction.down)
            .collect(Collectors.toCollection(ArrayList::new)));
